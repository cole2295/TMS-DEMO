...
namespace Vancl.TMS.DAL.Oracle.Sorting.Outbound
{
	...
	/// 出库批次数据层实现
	/// </summary>
	public class OutboundBatchV2DAL : BaseDAL, IOutboundBatchV2DAL
	{
		...
		public int Update(OutboundBatchEntityModel batchModel)
		{
			if (batchModel == null) throw new ArgumentNullException("batchModel is null");
			StringBuilder strSql = new StringBuilder();
			strSql.Append(@"update sc_outboundbatch t 
							set t.outboundcount=:OutboundCount,
								t.updateby=:UpdateBy,
