...
namespace Vancl.TMS.ConfigManagerTool
{
    public partial class MainForm : Form
    {
        ...
        private string FormulaValueChecking()
        {
            ...
            string className = this.tbfClassName.Text.Trim();
            string assName = this.tbfAssName.Text.Trim();
            string desc = this.tbfDesc.Text.Trim();
            ...
            if (string.IsNullOrWhiteSpace(serviceName))
                ...
                return "公式类名不能为空.";
            else if (string.IsNullOrWhiteSpace(assName))
                return "公式程序集不能为空.";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (hasService)
            {
                ...
                if (SaveServiceConfig())
                {
                    ...
                    this.tbServiceName.Text = string.Empty;
            ...
            if (HasFormula())
            {
                ...
                if (SaveFormulaConfig())
                {
                    this.tbfFormulaName.Text = string.Empty;
                    this.tbfDesc.Text = string.Empty;
                    MessageBox.Show("保存成功");
                }
            }
        ...
        private bool IsNameExsists(bool isFormulaConfig, string name)
        {
            StreamReader sr = File.OpenText(isFormulaConfig ? formulaConfigPath : serviceConfigPath);
        ...
        private bool SaveFormulaConfig()
        {
            string serviceName = this.tbfFormulaName.Text.Trim();
            string interfaceName = this.tbfInterfaceName.Text.Trim();
            string className = this.tbfClassName.Text.Trim();
            ...
            if (IsNameExsists(true, serviceName))
            {
                MessageBox.Show("公式" + serviceName + "已存在.");
                return false;
            }
        ...
        private bool SaveServiceConfig()
        {
            string serviceName = this.tbServiceName.Text.Trim();
            string interfaceName = this.tbInterfaceName.Text.Trim();
            string className = this.tbClassFullName.Text.Trim();
            ...
            if (IsNameExsists(false, serviceName))
            {
                MessageBox.Show("服务" + serviceName + "已存在.");
                return false;
            }
